...
Private Sub Command1_Click()
    Data1.Recordset.FindFirst "memID = '" & Text1.Text & "'"
        ...
        frmMain.Show
        frmLogin.Hide
        MsgBox ("you must press EDIT before you save changes to an exsisting record or you will get an error. If you know how to disable the save button untill the edit button is pressed then please email me and let me know how. weis1983@msn.com"), vbOKOnly, "Please help if you can"
        MsgBox ("If you chat at www.vbchat.com and know the new URL please email me with it thanks and enjoy.  weis1983@msn.com"), vbOKOnly, "Employee Tracker"
        Text1.Text = ""
        Text2.Text = ""
        Exit Sub
